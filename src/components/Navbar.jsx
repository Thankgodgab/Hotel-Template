...
const Navbar = () => {
    ...
    return (
        <header className="bg-black px-10 py-5 relative">
            ...
            <div
                className={`fixed top-15 right-0 h-full w-3/4 bg-black text-white flex flex-col px-10 gap-6 transition-transform duration-500 ease-in-out transform ${isOpen ? "translate-x-0" : "translate-x-full"
                    } z-50`} 
            >
